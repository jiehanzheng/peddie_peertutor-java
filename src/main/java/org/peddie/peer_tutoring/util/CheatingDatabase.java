...
public class CheatingDatabase implements Database {
	...
	public Set<Tutor> getTutors() {
		...
		tutors.add(new Tutor("CompSci guy", Dorm.POTTER_NORTH, null, null, new HashSet<Subject>(Arrays.asList(Subject.COMPSCI, Subject.CHINESE))));
		tutors.add(new Tutor("Chemistry guy", Dorm.CASPERSEN, null, null, new HashSet<Subject>(Arrays.asList(Subject.CHINESE, Subject.CHEMISTRY))));
