...
public class PlainOldJavaClassDatabase implements Database {
	...
	public Set<Tutor> getTutors() {
		...
		tutors.add(new Tutor("Scout Sabo", "ssabo-14", Dorm.AVERY, 
				new HashSet<DutyDay>(Arrays.asList(DutyDay.THURSDAY)), 
				new HashSet<Subject>(Arrays.asList(Subject.FRENCH, Subject.PRE_CALCULUS, Subject.CALCULUS, Subject.ENGLISH))));
		...
		tutors.add(new Tutor("Jacky Ziwen Jiang", "zjiang-14", Dorm.POTTER_SOUTH, 
				...
				new HashSet<Subject>(Arrays.asList(Subject.CHEMISTRY, Subject.BIOLOGY, Subject.PHYSICS, Subject.ALGEBRA, Subject.GEOMETRY, Subject.PRE_CALCULUS, Subject.CALCULUS_AB, Subject.CALCULUS_BC, Subject.CHINESE, Subject.ACT))));
		
		tutors.add(new Tutor("Zui Dighe", "zdighe-15", Dorm.LIBRARY, 
				new HashSet<DutyDay>(Arrays.asList(DutyDay.TUESDAY)), 
				new HashSet<Subject>(Arrays.asList(Subject.BIOLOGY, Subject.ALGEBRA, Subject.GEOMETRY, Subject.PRE_CALCULUS, Subject.CALCULUS_AB, Subject.CALCULUS_BC, Subject.SPANISH_2, Subject.SPANISH_3, Subject.SPANISH_4))));
